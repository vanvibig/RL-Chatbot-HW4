...
all_words_path = 'data/move_lines.txt'

def preProBuildWordVocab(word_count_threshold=5, all_words_path=all_words_path):
...
if __name__ == '__main__':
    ...
    utterance_dict = {}
    with codecs.open('data/sent_list.txt', "w", encoding='utf-8', errors='ignore') as f:
        for line in raw_movie_lines:
            line = line.split(' +++$+++ ')
            line_ID = line[0]
            utterance = line[-1]
